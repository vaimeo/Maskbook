...
export const getBalanceValue = (asset: Web3Plugin.FungibleAsset<Web3Plugin.FungibleToken>) =>
...
export const makeSortAssertWithoutChainFn = () => {
    return (
        a: Web3Plugin.FungibleAsset<Web3Plugin.FungibleToken>,
        b: Web3Plugin.FungibleAsset<Web3Plugin.FungibleToken>,
    ) => {
